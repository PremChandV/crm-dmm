...
//UPDATE an USER in "tbl_sales_team"
    if("UPDATE_USER" == $action)
    {
        ...
        $sql = "UPDATE $table SET `user_id`='.$id.', `firstname`='".$firstName."',
            ...
            `description`='".$description."' WHERE `user_id`='.$id.'";
...
///DELETE an USER in "tbl_sales_team"
